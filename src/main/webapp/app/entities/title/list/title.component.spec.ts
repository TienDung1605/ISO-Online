...
import { sampleWithRequiredData } from '../title.test-samples';
...
describe('Title Management Component', () => {
  ...
  beforeEach(() => {
    TestBed.configureTestingModule({
      imports: [RouterTestingModule.withRoutes([{ path: 'title', component: TitleComponent }]), HttpClientTestingModule, TitleComponent],
      providers: [
        {
