...
import { sampleWithRequiredData } from '../report-type.test-samples';
...
describe('ReportType Management Component', () => {
  ...
  beforeEach(() => {
    TestBed.configureTestingModule({
      imports: [
        RouterTestingModule.withRoutes([{ path: 'report-type', component: ReportTypeComponent }]),
  ...
  it('Should call load all on init', () => {
    ...
    expect(comp.reportTypes?.[0]).toEqual(expect.objectContaining({ id: 123 }));
  });

  describe('trackId', () => {
    it('Should forward to reportTypeService', () => {
      const entity = { id: 123 };
      jest.spyOn(service, 'getReportTypeIdentifier');
      const id = comp.trackId(0, entity);
      expect(service.getReportTypeIdentifier).toHaveBeenCalledWith(entity);
