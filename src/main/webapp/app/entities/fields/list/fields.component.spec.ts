...
import { sampleWithRequiredData } from '../fields.test-samples';
...
describe('Fields Management Component', () => {
  ...
  beforeEach(() => {
    TestBed.configureTestingModule({
      imports: [RouterTestingModule.withRoutes([{ path: 'fields', component: FieldsComponent }]), HttpClientTestingModule, FieldsComponent],
      providers: [
        {
